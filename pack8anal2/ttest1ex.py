...
# 귀무 : 한국연구소에서 개발한 백열전구의 수명은 300 시간이다. (250 + 50)
...
print(np.array(one_sample).mean())  # 289.785714 vs 300 차이가 있을까?
result = stats.ttest_1samp(one_sample, popmean=300)
print('t-value:%.3f, p-value:%.3f'%result)  # t-value:-1.556, p-value:0.144
#====================================================================================
# 해석 : p-value:0.144 > 0.05 이므로 귀무가설 채택. 한국연구소에서 개발한 백열전구의 수명은 300 시간이다.
#====================================================================================
...
# 귀무 : 국내에서 생산된 노트북의 평균 사용 시간은 5.2.시간이다.
# 대립 : 국내에서 생산된 노트북의 평균 사용 시간은 5.2.시간이 아니다.
...
print(data.time.mean())   # 5.5568 vs 5.2 평균에 차이가 있는가?

result2 = stats.ttest_1samp(data.time, popmean=5.2)
print('t-value:%.6f, p-value:%.6f'%result2)   # t-value:3.946060, p-value:0.000142
#===========================================================================================
# 해석 : p-value:0.000142 < 0.05 이므로 귀무가설 기각. 국내에서 생산된 노트북의 평균 사용 시간은 5.2.시간이 아니다.
#===========================================================================================
...
data2 = pd.read_excel("개인서비스지역별_동향[2022-10월]118-10시6분.xls").T.dropna().iloc[2:,]
data2.columns = ['컷트가격']
print(data2)
print(np.mean(data2.컷트가격))  # 17367.56 vs 15000 차이?

result3 = stats.ttest_1samp(data2.컷트가격, popmean=15000)
