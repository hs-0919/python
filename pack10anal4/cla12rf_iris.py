# Logistic Regression : 다항분류(얘는 활성화 함수 softmax 사용 - 결과값을 확률로 반환)
# LogisticRegression은 다중 클래스를 지원하도록 일반화 되어 있다. softmax 함수를  사용하기 때문에 
...
model = RandomForestClassifier(criterion='entropy', n_estimators=500, random_state=1, n_jobs=1) #  n_jobs - cpu갯수
